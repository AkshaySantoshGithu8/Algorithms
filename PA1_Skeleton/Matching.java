...
public class Matching {
    ...
    /**
     * A list containing each school's preference list.
     */
    private ArrayList<ArrayList<Integer>> school_preference;
    ...
    /**
     * Number of openings available for each school.
     */
    private ArrayList<Integer> school_openings;

    /**
     * Matching information representing the index of the school a student is matched to,
     * -1 if not matched.
     *
    ...
    public Matching(
            Integer m,
            Integer n,
            ArrayList<ArrayList<Integer>> school_preference,
            ArrayList<ArrayList<Integer>> student_preference,
            ArrayList<Integer> school_openings) {
        this.m = m;
        this.n = n;
        this.school_preference = school_preference;
        this.student_preference = student_preference;
        this.school_openings = school_openings;
    ...
    /**
     * Constructs a solution to the stable matching problem, given the problem as a Matching.
     * Takes a Matching which represents the problem data with no solution, and a
     * student_matching which solves the problem given in data.
     *
    ...
    public ArrayList<ArrayList<Integer>> getSchoolPreference() {
    ...
    public ArrayList<Integer> getSchoolOpenings() {
        return school_openings;
    }
    ...
    public int totalSchoolOpenings() {
        int openings = 0;
        for (int i = 0; i < m; i++) {
            openings += school_openings.get(i);
        }
        return openings;
    }
